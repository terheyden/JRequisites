...
class RequireTest {
    ...
    void requireNotNull() {
        ...
        assertThatNullPointerException().isThrownBy(() -> Require.requireNotNull(nullStr, ERROR)).withMessage(ERROR);
    }
    ...
    void requireNotEmpty_string() {
        ...
        assertThatNullPointerException().isThrownBy(() -> Require.requireNotEmpty(nullStr, ERROR)).withMessage(ERROR);
    ...
    void requireNotEmpty_collection() {
        ...
        assertThatNullPointerException().isThrownBy(() -> Require.requireNotEmpty(nullList, ERROR)).withMessage(ERROR);
    ...
    void requireNotEmpty_map() {
        ...
        assertThatNullPointerException().isThrownBy(() -> Require.requireNotEmpty(nullMap, ERROR)).withMessage(ERROR);
    ...
    void requireNotEmpty_array() {
        ...
        assertThatNullPointerException().isThrownBy(() -> Require.requireNotEmpty(nullArray, ERROR)).withMessage(ERROR);
    ...
    void requireNotBlank() {
        ...
        assertThatNullPointerException().isThrownBy(() -> Require.requireNotBlank(nullStr, ERROR)).withMessage(ERROR);
        assertThatIllegalArgumentException().isThrownBy(() -> Require.requireNotBlank(emptyStr)).withMessage("String is empty");
        assertThatIllegalArgumentException().isThrownBy(() -> Require.requireNotBlank(emptyStr, ERROR)).withMessage(ERROR);
        assertThatIllegalArgumentException().isThrownBy(() -> Require.requireNotBlank(blankStr)).withMessage("String is blank");
        assertThatIllegalArgumentException().isThrownBy(() -> Require.requireNotBlank(blankStr, ERROR)).withMessage(ERROR);
    }
    ...
    void requireLength_string() {
        ...
        assertThatNullPointerException().isThrownBy(() -> Require.requireLength(nullStr, 1, ERROR)).withMessage(ERROR);
        assertThatIllegalArgumentException().isThrownBy(() -> Require.requireLength(goodStr, goodStr.length() + 1)).withMessage("String length is less than " + (goodStr.length() + 1));
        assertThatIllegalArgumentException().isThrownBy(() -> Require.requireLength(goodStr, goodStr.length() + 1, ERROR)).withMessage(ERROR);
    }
    ...
    void requireSize_collection() {
        ...
        assertThatNullPointerException().isThrownBy(() -> Require.requireSize(nullList, 1, ERROR)).withMessage(ERROR);
        assertThatIllegalArgumentException().isThrownBy(() -> Require.requireSize(goodList, goodList.size() + 1)).withMessage("Collection size is less than " + (goodList.size() + 1));
        assertThatIllegalArgumentException().isThrownBy(() -> Require.requireSize(goodList, goodList.size() + 1, ERROR)).withMessage(ERROR);
    }
    ...
    void requireSize_map() {
        ...
        assertThatNullPointerException().isThrownBy(() -> Require.requireSize(nullMap, 1, ERROR)).withMessage(ERROR);
        assertThatIllegalArgumentException().isThrownBy(() -> Require.requireSize(goodMap, goodMap.size() + 1)).withMessage("Map size is less than " + (goodMap.size() + 1));
        assertThatIllegalArgumentException().isThrownBy(() -> Require.requireSize(goodMap, goodMap.size() + 1, ERROR)).withMessage(ERROR);
    }
}
